...
<head>
    ...
    <script src="/js/province/script.js"></script>
</head>
<body>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title">Add Province</h2>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="create-form" role="form" method="POST" action="/ui/provinces/create/">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select name="create-state" class="custom-select" required>
        ...
        <div id="ModalUpdateForm" class="modal fade">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title">Update Existing Province</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="update-form" role="form" method="POST" action="">
                            ...
                            <div class="form-group">
                                <label class="control-label">State</label>
                                <div>
                                    <select name="update-state" class="custom-select" required>
                                        <#list states as state>
                                            <option value="${state}">${state.name()}</option>
                                        </#list>
                                    </select>
        ...
        <div id="ModalDelete" class="modal fade">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title">Delete Province</h2>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h2>Are you sure?</h2>
                        <p>Do you want to delete this province?</p>
